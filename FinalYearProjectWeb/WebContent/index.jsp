        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    <h2>GAA Application to improve player management</h2>
                </div>
            </div>
            <div class="item">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('http://clas.wayne.edu/Multimedia/NFS/Images/Media/1034.jpg');"></div>
                <div class="carousel-caption">
